...
// SVG Icons as React Components for clean, dependency-free rendering
const Icons = {
  Folder: () => (
  ...
  Owner: ({ size = 12, style = {} }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, ...style }}>
      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
      <circle cx="12" cy="7" r="4" />
    </svg>
  ),
  Collab: ({ size = 12, style = {} }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, ...style }}>
...
export const OwnerIcon = Icons.Owner;
export const CollabIcon = Icons.Collab;
export const PinIcon = Icons.Pin;
export const ThreeDotsIcon = Icons.ThreeDots;
