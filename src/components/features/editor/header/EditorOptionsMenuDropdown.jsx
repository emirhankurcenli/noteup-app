  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: '0.70rem', fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', padding: '4px 10px 2px 10px' }}>
        {lang === 'tr' ? 'Eklenti Ekle' : 'Add Widget'}
      </div>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Yapılacaklar Listesi' : 'To-Do List'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Borç / Alacak Takibi' : 'Debt Tracker'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Fatura Takibi' : 'Bill Tracker'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Şifre Kasası' : 'Password Vault'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Araç / Otopark Konumu' : 'Car Parking GPS'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Sınav Sayacı' : 'Exam Countdown'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Görsel / Dosya Ekle' : 'Attach Photo / File'}</span>
      </button>
      ...
      >
        ...
        <span>{lang === 'tr' ? 'Ses Kaydı Başlat' : 'Start Audio Record'}</span>
      </button>
