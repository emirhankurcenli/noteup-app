...
export const getApiKey = () => {
  return import.meta.env.VITE_REVENUECAT_ANDROID_KEY || import.meta.env.VITE_REVENUECAT_KEY || "goog_klpvzugPjsJwnTuzpqHEafDShcM";
};
...
export const initBilling = async (setUserPlan) => {
  try {
    ...
    console.error("Android RevenueCat billing init failed:", err);
  }
};
